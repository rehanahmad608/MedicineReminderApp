...
class ScreenTwo extends StatelessWidget {
  ...
  static const routeName = '/intro-two-screen';
  ...
  Widget build(BuildContext context) {
    ...
    Widget _displayHeading() =>
        const IntroHeading(heading: 'Receive Reminders At Fixed Time');
    ...
    Widget _displayBodyImage() => Image(
          image: const AssetImage('assets/images/ScreenTwo.png'),
